...
export default function Privacy() {
  return (
    <div className="privacyPolicy">
      ...
      <p>
        Your privacy is important to us. It is Dungeon Delver's policy to
        ...
        across our website, <a href="http://localhost">http://localhost</a>, and
        other sites we own and operate.{" "}
      </p>
      <p>
        This policy is effective as of 5 July 2022 and was last updated on 5
        July 2022.{" "}
      </p>
