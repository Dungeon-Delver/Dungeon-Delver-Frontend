...
export default function MyParties() {
    ...
    return (
      <div className="my-parties">
        <Link to={`/create-party`}>
          <button className="create-party-button">Create a Party</button>
        </Link>
        <div className="error">
  ...
  return (
    <div className="my-parties">
      <Link to={`/create-party`}>
        <button className="create-new-party-button">Create a Party</button>
      </Link>
      {parties != null ? (
        ...
        <h2 className="no-parties">
          You are not currently in any parties. Find or create one to begin!
        </h2>
      )}
    </div>
  );
