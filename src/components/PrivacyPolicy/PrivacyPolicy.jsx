export default function PrivacyPolicy() {
	return (
		<div className="privacy-policy">
			...
			<div>
				Your privacy is important to us. It is Dungeon Delver's policy
				...
				http://dungeon-delver.vercel.app, and other sites we own and
			...
			<div>
				...
				errors you may encounter. Please be aware that while this
				information may not be personally identifying by itself, it may
				be possible to combine it with other data to personally identify
				individual persons.
			</div>
			...
			<div>Use a mobile device or web browser to access our content</div>
			<div>
				Contact us via email, social media, or on any similar
				technologies
			</div>
			<div>When you mention us on social media</div>{" "}
			<div>
			...
			<div>Kareem DaCosta</div>
			<div>kareemdacosta@meta.com</div>
		</div>
	);
}
